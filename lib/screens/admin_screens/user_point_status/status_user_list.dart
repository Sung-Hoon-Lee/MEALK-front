...
class StatusUserList extends StatefulWidget {
  const StatusUserList({super.key});

  @override
  State<StatusUserList> createState() => _StatusUserListState();
}

class _StatusUserListState extends State<StatusUserList> {
                            ...
                            trailing: Container(
                              ...
                              IconButton(
                                ...
                                onPressed: () async{
                                  ...
                                  Navigator.pushNamed(
                                      context, 'statusDetail', arguments: idset[index]);
                                },
                              ),
                            ),
                          );
