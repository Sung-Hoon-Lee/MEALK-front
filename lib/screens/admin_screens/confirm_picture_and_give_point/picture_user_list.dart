...
class PointUserList extends StatefulWidget {
  const PointUserList({super.key});

  @override
  State<PointUserList> createState() => _PointUserListState();
}

class _PointUserListState extends State<PointUserList> {
                            ...
                            trailing: Container(
                              ...
                              IconButton(
                                ...
                                onPressed: () async{
                                  ...
                                  Navigator.pushNamed(
                                      context, 'pictureList', arguments: idset[index]);
                                },
                              ),
                            ),
                          );
