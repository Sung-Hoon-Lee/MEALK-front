...
class ModifyUserDetail extends StatefulWidget {
  const ModifyUserDetail({super.key});

  @override
  State<ModifyUserDetail> createState() => _ModifyUserDetailState();
}

class _ModifyUserDetailState extends State<ModifyUserDetail> {
